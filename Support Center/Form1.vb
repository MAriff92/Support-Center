...
INSERT INTO _edc_ftp (_hostname, _port, _uname, _pword, flag, _cert, _modified_date, _encryption) VALUES ('eqmpdata1.doe.gov.my', '9955', 'CAQMv2', 'pstw2020_caqm', 1,'','2022-01-01 00:00:00','none');
...
INSERT INTO _mstr_analyzer (name, _model_name, comm_addrs, com_port, flag, _stationId, analyzer_port, period, time_out, poll_control, unit_id, database_name, modified_date) VALUES ('AIO', 'AIO ', '','COM1', @aio_stats, @stationID, '', 12, '3000', '1', '', '', '2022-01-01 00:00:00')", connection)
            ...
            mysqlcommand.Parameters.Add("@HQFTP_username", MySqlDbType.VarChar).Value = HQFTP_username
            mysqlcommand.Parameters.Add("@HQFTP_password", MySqlDbType.VarChar).Value = HQFTP_password
...
UPDATE _edc_ftp SET _hostname = 'eqmpdata1.doe.gov.my', _port = '9955', _uname = 'CAQMv2', _pword = 'pstw2020_caqm', flag = 1, _cert = '', _modified_date = '2022-01-01 00:00:00', _encryption = 'none' WHERE autoid = 1;
